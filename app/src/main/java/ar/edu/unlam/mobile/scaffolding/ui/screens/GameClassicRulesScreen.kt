...
@Composable
fun GameClassicRulesScreen(controller: NavHostController) {
    Column(
        modifier =
            Modifier
                .fillMaxSize()
        ...
        Column(
            ...
            Spacer(Modifier.height(16.dp))
            Text(
                "¿Serás capaz de responder las 10 preguntas de forma correcta?",
                fontSize = 14.sp,
                fontFamily = AppFont.Quicksand,
                fontWeight =
                    FontWeight
            ...
            Image(
                painter = painterResource(id = R.drawable.game_classic_rules),
                contentDescription = "Logo",
                modifier =
                    Modifier
                        .fillMaxWidth()
